...
System.register(['./ViewMaster', '../helper/DateHelper'], function (_export, _context) {
  "use strict";

  var ViewMaster, DateHelper, _createClass, NegociacoesView;
  ...
  return {
    setters: [function (_ViewMaster2) {
      ViewMaster = _ViewMaster2.ViewMaster;
    ...
    execute: function () {
      ...
      _export('NegociacoesView', NegociacoesView = function (_ViewMaster) {
        _inherits(NegociacoesView, _ViewMaster);
