...
System.register(['./HttpService', '../model/Negociacao', './ConnectionFactory', '../dao/NegociacaoDao', '../helper/NegociacaoHelper'], function (_export, _context) {
  "use strict";

  var HttpService, Negociacao, ConnectionFactory, NegociacaoDao, NegociacaoHelper, _createClass, NegociacaoService;
  ...
  return {
    ...
    }, function (_helperNegociacaoHelper) {
      NegociacaoHelper = _helperNegociacaoHelper.NegociacaoHelper;
    }],
    execute: function () {
